...
// GET - Retrieve all measurements (for all people)
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await sql`
      INSERT INTO measurements (name, leg_length, height_90_degree, weight_kg, user_email)
      VALUES (${name}, ${legLengthNum}, ${height90DegreeNum}, ${weightKgNum}, ${session.user.email})
